...
export const OutlineView = memo(function OutlineView({ headings, currentLine, onJumpToLine }: OutlineViewProps) {
  if (headings.length === 0) {
    return (
      <div className="sidebar-empty">
        <svg className="w-6 h-6 text-muted-foreground/20 mb-1.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.2} strokeLinecap="round" strokeLinejoin="round">
